import logging
from qrng_kyber_py.qkyber import qKyber512

# Configure logging: overwrites previous logs on each run.
logging.basicConfig(
    filename='logs/qnrg_kyber512.log',
    level=logging.INFO,
...
class KyberKeyExchange:
    ...
    def __init__(self):
        ...
        # Generate key pair
        self.public_key, self.secret_key = qKyber512.keygen()
    ...
    def encapsulate(self):
        ...
        self.shared_key, self.ciphertext = qKyber512.encaps(self.public_key)
    ...
    def decapsulate(self):
        ...
        derived_key = qKyber512.decaps(self.secret_key, self.ciphertext)
